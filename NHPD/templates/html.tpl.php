...
<body class="<?php print $classes; ?>" <?php print $attributes;?>>
  <div style="padding:0px 0px 5px 0px;">
    ...
    <img src="<?php global $base_path; print $base_path.path_to_theme(); ?>/images/sig-eng.gif" width="372" height="20" alt="Health Canada">
    </div>
    <div style="text-align: right;">
    <img src="<?php global $base_path; print $base_path.path_to_theme(); ?>/images/wmms.gif" width="83" height="20" alt="Canada">
    </div>
  </div>
  <div id="skip-link">
